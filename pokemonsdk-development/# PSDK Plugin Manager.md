...
In the case you need any visual example, please check [this repository](https://gitlab.com/NuriYuri/psdk-plugins) as it shows how a plugin should be structured.
