module Battle
  ...
  class Visual
    ...
    # Create all the animations for the visuals
    def create_animations
      create_animation_ability_bars
      create_animation_battlers
      create_animation_info_bars
      create_animation_item_bars
      create_animation_team_info
    ...
    # Create the battler animations
    def create_animation_battlers
      @battlers.each_value do |battlers|
        battlers.each_value(&:create_animation)
      end
    end
    ...
    # Create the info bars animations
    def create_animation_info_bars
      @info_bars.each_value do |info_bars|
        info_bars.each(&:create_animation)
      end
    end
    ...
    def create_animation_ability_bars
      @ability_bars.each_value do |ability_bars|
        ability_bars.each(&:create_animation)
        ability_bars.each { |ability_bar| ability_bar.go_out(-3600) }
      end
    end
    ...
    # Create the item bars animations
    def create_animation_item_bars
      @item_bars.each_value do |item_bars|
        item_bars.each(&:create_animation)
        item_bars.each { |item_bar| item_bar.go_out(-3600) }
      end
    end
    ...
    # Create the Trainer Party Ball animation
    def create_animation_team_info
      @team_info.each_value(&:create_animation)
    end
