  ...
  module AI
    class Base
      ...
      def move_power(move, user, target, effectiveness)
        ...
        # Modified cumulative distribution function based on normal distribution.
        # The mean and standard deviation are arbitrary chosen to draw the best curve.
        # Both take account of the base power and effectiveness of the move.
        # The minimum output is 0.75 while the maximum value is 1.0.
